...
1. **突出 v0.2.0 新功能**：定时任务、Webhook、TUI、许可分层
...
| 🔔 Webhook | Bell | 多渠道通知 | Slack/Discord/飞书/钉钉/企微/Bark |
| 💻 TUI | Terminal | 终端管理界面 | 8 屏终端界面，会话/配置/日志管理 |
| 🛡️ 安全 | Shield | 多重安全防护 | 白名单 + DKIM/SPF + 命令黑名单 |
| ⚡ 双模式 | Zap | 灵活运行模式 | Reply Mode + Cold Start 全场景覆盖 |
| 🌐 多邮箱 | Mail | 主流邮箱支持 | Gmail / Outlook / QQMail / 126Mail |
